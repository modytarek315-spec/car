...
(function () {
    ...
    const SUPABASE_URL = 'https://wfeaiuibfgygyjbrzppo.supabase.co'; // e.g., https://xxxxx.supabase.co
    const SUPABASE_ANON_KEY = 'sb_publishable_Dguds62bzgUGj-JuojWoRw_eSLznFyV'; // Public anon key
